# GH-900 GitHub Foundations 受講者向け配布資料

研修で使う演習（GitHub Skills / Microsoft Learn）は英語です。このリポジトリに日本語の手順を置いています。
演習中は、英語の画面とこの日本語を並べて読んでください。

## 使い方

- 演習は GitHub Skills の日本語版テンプレート（`mamezou/skills-ja-*`）から始めます。手順は自分のリポジトリの Issues（M15 は README）に日本語で表示されます。各資料の「演習の開始」リンクから作ってください。
- 各演習は「開始リンク」から自分のリポジトリを作って始めます。リンクは各ファイルの冒頭にあります。
...
- [GH-900 試験の学習ガイド](https://learn.microsoft.com/ja-jp/credentials/certifications/resources/study-guides/gh-900)
- [GitHub Foundations Part 1（Learn、日本語）](https://learn.microsoft.com/ja-jp/training/paths/github-foundations/)
- [GitHub Foundations Part 2（Learn、日本語）](https://learn.microsoft.com/ja-jp/training/paths/github-foundations-2/)
