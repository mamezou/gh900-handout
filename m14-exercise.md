...
**Add a suggestion** は、コメント入力欄にあるボタンです。押すと、専用の書式のコードブロックが挿入されます。GitHub は、コメントを表示するだけでなく **Apply suggestion** ボタンも表示します。作成者はボタンひとつで提案を受け入れてコミットできます。コードエディターを開く必要はありません。便利ですね！
...
2. 下へスクロールし、**Apply suggestion** ボタンをクリックすると、コミットメッセージの入力欄が開きます。
